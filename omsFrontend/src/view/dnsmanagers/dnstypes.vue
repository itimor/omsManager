...
<script>
  import {getDnsType, deleteDnsType} from '@/api/dnsmanager'
  import addGroup from './components/adddnstype.vue'
  import editGroup from './components/editdnstype.vue'
  ...
  export default {
            ...
            render: (h, params) => {
              return h('div', [
                ...
                h('Poptip', {
                  ...
                  on: {
                    'on-ok': () => {
                      deleteDnsType(params.row.id).then(res => {
                        this.fetchData()
                      })
                    },
                    'on-cancel': () => {
    ...
    methods: {
      fetchData() {
        getDnsType(this.listQuery).then(res => {
